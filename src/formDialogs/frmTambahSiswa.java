 ...
 * @author Lenovo
 */
public class frmTambahSiswa extends javax.swing.JDialog {

    /**
     * Creates new form frmTambahSiswa
     */
    public frmTambahSiswa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tampilKelas();
    }
    ...
    private void tblSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tblSimpanActionPerformed
        ...
        String nisRegex = "^[S]{1}[0-9]{4}$";
//
        CharSequence inputStr = txtNama.getText();
        Pattern pattern = Pattern.compile(new String ("^[a-zA-Z\\s]*$"));
        Matcher matcher = pattern.matcher(inputStr);
//
        if(!txtNIS.getText().matches(nisRegex)) {
            JOptionPane.showMessageDialog(null
                ,"NIS kombinasi 5 Karakter diawali Huruf S dan 4 angka!! Contoh: S9876",
                "Error!",
...
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTambahSiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmTambahSiswa dialog = new frmTambahSiswa(new javax.swing.JFrame(), true);
